...
This is a site that helps you figure out if you actually need something right now, and whether it's really necessary for you or not.

In the future, I could add a database and a backend, and let every user have an account so they can come back and see what they wanted to know before. That would make it better.

## How was this project built?

I did about 90% of the HTML myself, 75% of the CSS, and 65% of the JS. This was a new project for me, and honestly I'm not an expert in JavaScript, so I learned it along the way with AI, one step at a time. To be honest, it helped me a lot with this project.
